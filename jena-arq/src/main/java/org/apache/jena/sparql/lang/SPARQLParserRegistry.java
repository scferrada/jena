...
public class SPARQLParserRegistry
{
    ...
    private static synchronized void init()
    {
        ...
        reg.add(Syntax.syntaxSPARQL_SJ_11,
                new SPARQLParserFactory() {
                    @Override
                    public boolean accept( Syntax syntax ) { return Syntax.syntaxSPARQL_SJ_11.equals(syntax) ; }
                    @Override
                    public SPARQLParser create( Syntax syntax ) { return new ParserSPARQLSJ11() ; } }) ;
