...
//    private static final Syntax syntaxSPARQL_Update = syntaxSPARQL_11_Update ;
    ...
    static {
        ...
        querySyntaxNames.put("sparql_sj_11",   syntaxSPARQL_SJ_11) ;
        querySyntaxNames.put("sparqlsj_11",   syntaxSPARQL_SJ_11) ;
    ...
    public static Syntax make(String uri)
    {
        ...
        if ( sym.equals(syntaxSPARQL_SJ_11) )   return syntaxSPARQL_SJ_11 ;
