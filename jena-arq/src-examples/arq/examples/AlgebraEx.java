...
public class AlgebraEx
{
    public static void main(String []args)
    {
        ...
        String s = "PREFIX ex:<http://ex.com/> SELECT DISTINCT ?id ?a1 ?b1 { ?id ex:a ?a1; <http://ex.com/b> ?b1 } similarity join on (?a1 ?b1) (?a2 ?b2) with distance manhattan as ?d within 2 SELECT DISTINCT ?id2 ?a2 ?b2 { ?id2 ex:a ?a2; <http://ex.com/b> ?b2 }";
        // Parse
